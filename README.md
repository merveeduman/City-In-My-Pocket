...
<details>
  <summary>1.Sprint Notları</summary>
  <ol> Proje yönetimi ve görev dağılımının ayarlanması için Trello kullanılmasına karar verilmiştir.   
...
Veritabanı yönetimi için Firebase kullanılmasına karar verilmiştir. 
   <details>
  <summary>1.Puanlama</summary>
    <ol> Sprint İçinde Tamamlanması Tahmin Edilen Puan = 10  
     Puan Tamamlama Mantığı: (Sprint içi puan değerlendirmesi 10 olarak belirlenmiştir.) Proje boyunca tamamlanması gereken backlog puanı 36'dır. İlk Sprint için bitirilmesi istenilen puan sayısı 10 olarak belirlenmiştir ve hedefe ulaşılmıştır.
     </details>
</details>
<details>
...
04.07.2024 tarihli beşinci toplantıda uyguluma fikrinin temel çerçeve kapsamı netleştirilmiştir. Netleşen uygulama fikrinin ürünleştirilmesine yönelik temel kapsam product başlığında verilmiştir.  
...
## • İLK SPRİNT FİNALİ ÖNCESİ SON TOPLANTI
### 05.07.2024 (Altıncı çevrimiçi toplantı)
05.07.2024 tarihli altıncı çevrimiçi toplantıda Merve'nin hazırlamış olduğu uygulamanın tanıtım ekranları ve İlker'in hazırladığı İş Modeli Kanvası ve kullanıcı personaları incelenmiş ve fikir birliği ile uygun bulunmuştur. İlgili ekran görüntüleri "Ürün" başlığında verilmiştir.
</details>
<details>
...
#### • Personalar ve İş Modeli Kanvası
...
![image](https://github.com/merveeduman/oua_bootcamp/assets/153215629/a65c59fd-13f8-4333-8336-0909de1c233a)
 ...
 <details>
   ...
   <ol> • Tanıtım sayfa tasarımlarının ilgi çekici ve kullanıcı dostu arayüze sahip olduguna ve diğer sayfaların da bu tarzda olmasına karar verilmiştir.
...
Kapsam Netleştirme: Bir sonraki sprintte görevlerin daha detaylı ve gerçekçi bir şekilde planlanması için kodlama pratiğine girmeden önce uygulama kapsamının ve fonksiyonel detayların tamamen netleşmiş olması üzerine çalışma yapılması.
Logo Tasarımı: Uygulamanın logosunun 2. Sprintte yapılması.
Kodlama: Uygulamanın kodlama işlerinin 2. Sprintte tamamlanması
